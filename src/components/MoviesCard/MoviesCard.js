...
function MoviesCard({name, duration, image, isSaved}){
    ...
    const handleSaveMovie = () => setSaveMovie(!saveMovie)
    return(
        <li className='movie-card'>
            ...
            <div className='movie-card__container'>
                ...
                <button className={saveMovie ? 'movie-card__btn movie-card__btn-active' : 'movie-card__btn'} onClick={handleSaveMovie}></button>
            </div>
